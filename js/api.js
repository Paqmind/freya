...
Freya.get_popup = function (url, $button, currentButtonHtml) {
    ...
    .always(function () {
        if ($button !== undefined ) {
            Freya.removeSpinner($button, currentButtonHtml);
        }
    });
};
...
$(function () {
    ...
    $(document.body).on('click', 'button[data-api="ajax.get"]', function (event) {
        ...
        var currentButtonHtml = Freya.addSpinner($button);
    ...
    $(document.body).on('change', 'form[data-api="ajax.autoreload"] :input', function (event) {
        ...
        // To prevent multisending
        var currentButtonHtml = Freya.addSpinner($submit);
        ...
        function handle() {
            ...
            .always(function () {
              Freya.removeSpinner($submit, currentButtonHtml);
            });
        }
